    ...
    var ViewModel = function (moduleContext) {
        ...
        var vm = kendo.observable({
            ...
            */
            ...
            dsEmployeeExpandedList: function () {
                //  vm.fillGrid();
            },
            ...
            fillGrid: function () {
                ...
                this.set("dsEmployeeExpandedList", $ct.ds.emp.employee.getEmployeeExpandedList(this, function (result) {
                    ...
                    $.each(result.Data.ExpandedEmployees, function (index, record) {
                ...
                $ct.ds.emp.employee.deleteEmployeeById(e.data.Id, e.data.Version, function (data) {
                    ...
                    if ($ct.mt.isVersionConflict(data)) {
                        if ($ct.helpers.displayConfirmWindow($ct.msg.getVersionConflictReloadMsg())) {
                            vm.dsEmployeeExpandedList.read();
                        }
                        return;
                    }
            ...
            searchEmployeeExpanded: function (e) {
            ...
            vweelChkEmployee: function (e) {
                ...
                var ds = vm.get("dsEmployeeExpandedList");
            ...
            dsDataBoundEvent: function (dataEve) {
                ...
                $("#vwEmployeeExtendedList").find("#chkAll").click(function (e) {
                    ...
                    var childItems = $("#vwEmployeeExtendedList").find("input[data-item-type='child']");
                    if (e.target.checked) {
            ...
            btnFilterOffClick: function () {
                ...
                /*
                Commented for maintaining the facilitytype dropdown in ViewAll
            ...
            btnBulkUpdateClick: function () {
                ...
                //if (this.dsEmployeeExpandedList.data().length == 0) {
                ...
                $ct.ds.emp.employee.getEmployeeBulkUpdateLookup(this, function (result) {
                    ...
                    if (errorObj != null) {
                        ...
                        Boiler.UrlController.goTo($ct.rn.getBulkUpdateEmployeeExtended());
                    }
                });
                ...
                //                }
                //                else {
                //                    moduleContext.notify($ct.en.getShowValidationMsg(), $ct.msg.getValidateSelectedPatients());
                //                }
            ...
            btnExportExcelClick: function () {
                ...
                $ct.ds.emp.employee.exportEmplyeesExpandedListToExcel(this, function (result) {
