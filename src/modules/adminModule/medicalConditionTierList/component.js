...
define(['Boiler', './viewmodel', 'text!./view.html', 'i18n!./nls/resources'], function (Boiler, ViewModel, template, nls) {
    ...
    var Component = function (moduleContext) {
        ...
        moduleContext.listen($ct.en.getRefreshView(), function (viewName) {
            if ($ct.rn.getMedicalConditionTierList() == viewName) {
                refreshViewData();
            }
        });
        ...
        moduleContext.listen($ct.en.getMedicalConditionTierCreatedOrUpdated(), function () {

            if (vm) {
                vm.data.refreshMedicalConditionTierGrid();
            }
        });


        moduleContext.listen($ct.en.getDisplayMedicalConditionTierList(), function () {
        ...
        this.activate = function (parent, params) {
            ...
            moduleContext.parentContext.currentView = $ct.rn.getMedicalConditionTierList();
            ...
            if (!panel) {
                ...
                $("#vwMedicalConditionTierList, #vwmctlDgMedicalConditionTier").delegate("tbody>tr", "dblclick", function (element) {
                    Boiler.UrlController.goTo(vm.data.medicalConditionTierEditUrl(false));
                });
