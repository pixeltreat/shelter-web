...
function (Boiler, helpTmpl) {
    ...
    var ViewModel = function (moduleContext) {
        ...
        var vm = kendo.observable({
            ...
            oxygenDependentFilterLookUp: [],
            electricalDependentFilterLookUp: [],
            ...
            */
            ...
            fillGrid: function () {
                ...
                this.set("dsSheltereeList", $ct.ds.sheltree.sheltree.getShelterees(this, function (result) {
                    ...
                    vm.oxygenDependentFilterLookUp = result.Data.OxygenDependentLookupData;
                    vm.electricalDependentFilterLookUp = result.Data.ElectricalDependentLookupData;

                    $("#vwslDgSheltereeListParent").find(".k-grid-filter").click(function (e) {
                        ...
                        if ($(e.target).closest("th[data-field='OxygenDependent']").data("kendoFilterMultiCheck") != undefined) {

                            var fmc = $(e.target).closest("th").data("kendoFilterMultiCheck");
                            fmc.checkSource._view = vm.oxygenDependentFilterLookUp;
                        ...
                        if ($(e.target).closest("th[data-field='ElectricalDependent']").data("kendoFilterMultiCheck") != undefined) {

                            var fmc = $(e.target).closest("th").data("kendoFilterMultiCheck");
                            fmc.checkSource._view = vm.electricalDependentFilterLookUp;
                    ...
                    //    var gridObj = $("#vwslDgSheltereeList").data("kendoGrid");
                    //    if ((gridObj != undefined) && (gridObj != null)) {
                    //        gridObj.showColumn("ShelterName");
                    //        gridObj.hideColumn("ShelterName");
                    //    }
                    //}


                    if (vm.get("dsSheltereeList").total() > 0) {
                        $("#vwslBtnExcel").show();
                    }
                    else {
                        $("#vwslBtnExcel").hide();
                    ...
                    $.each(result.Data.SheltereeRawData, function (index, record) {
            ...
            dsDataBoundEvent: function (dataEve) {
                ...
                $("#vwSheltereeList").find("#chkAll").click(function (e) {
                    ...
                    var childItems = $("#vwSheltereeList").find("input[data-item-type='child']");
                    if (e.target.checked) {
            ...
            btnBulkUpdateClick: function () {
                ...
                //if (this.dsSheltereeList.data().length == 0) {
                ...
                if (
                    ...
                    moduleContext.notify($ct.en.getShowValidationMsg(), $ct.msg.getBulkUpdateSheltereeValidationMsg());
                ...
                $ct.ds.sheltree.sheltree.getSheltereeBulkUpdateLookup(this, function (result) {
                    ...
                    if (errorObj != null) {
                        ...
                        Boiler.UrlController.goTo($ct.rn.getBulkUpdateShelteree());
                    }
                });
                //ds.fetch();
            ...
            btnExportExcelClick: function () {
                ...
                $ct.ds.sheltree.sheltree.exportSheltereesListToExcel(this, function (result) {
            ...
            sheltereeEditUrl: function (isNew) {
                ...
                if (!isNew) {
                    return $ct.rn.getShelteree() + "/" + this.selectedId + "/" + this.selectedShelterId + "/" +$ct.rn.getSheltereeList() ;

                }
                else {
                    return $ct.rn.getShelteree() + "/" + $ct.constants.getemptyGUID() + "/" + moduleContext.parentContext.sheltereeHeaderData.shelter.Id + "/" + $ct.rn.getSheltereeList();
                }
