...
function (Boiler, helpTmpl) {
    ...
    var ViewModel = function (moduleContext) {
        ...
        var vm = kendo.observable({
            ...
            pageName: "Shelteree Medical Update List page",
            ...
            */
            ...
            dsSheltereeMedicalUpdateList: function () {
                //vm.fillGrid();
            },
            ...
            fillGrid: function () {
                ...
                var gridObj = $("#vwsmulDgSheltereeMedicalUpdateList").data("kendoGrid");
                ...
                this.set("dsSheltereeMedicalUpdateList", $ct.ds.sheltree.sheltree.getSheltereeMedicalUpdatees(this, function (result) {
                    ...
                    $.each(result.Data.MedicalUpdateRawData, function (index, record) {
                ...
                $ct.ds.sheltree.sheltree.deleteSheltereeMedicalUpdateById(e.data.Id, e.data.Version, function (data) {
                    ...
                    if ($ct.mt.isVersionConflict(data)) {
                        if ($ct.helpers.displayConfirmWindow($ct.msg.getVersionConflictReloadMsg())) {
                            vm.dsSheltereeMedicalUpdateList.read();
                        }
                        return;
                    }
            ...
            searchSheltereeMedicalUpdatees: function (e) {
            ...
            vwsmulChkSheltereeMedicalUpdate: function (e) {
                $ct.helpers.displayWorkAreaBusyCursor();
                ...
                var ds = vm.get("dsSheltereeMedicalUpdateList");
            ...
            dsDataBoundEvent: function (dataEve) {
                ...
                $("#vwSheltereeMedicalUpdateList").find("#chkAll").click(function (e) {
                    ...
                    var childItems = $("#vwSheltereeMedicalUpdateList").find("input[data-item-type='child']");
                    if (e.target.checked) {
            ...
            btnBulkUpdateClick: function () {
                ...
                //if (this.dsSheltereeMedicalUpdateList.data().length == 0) {
                ...
                $ct.ds.sheltree.sheltree.getSheltereeMedicalUpdateBulkUpdateLookup(this, function (result) {
                    ...
                    if (errorObj != null) {
                        ...
                        Boiler.UrlController.goTo($ct.rn.getBulkUpdateSheltereeMedicalUpdate());
                    }
                });
                //ds.fetch();
            ...
            btnExportExcelClick: function () {
                ...
                $ct.ds.sheltree.sheltree.exportSheltereeMedicalUpdateesListToExcel(this, function (result) {
