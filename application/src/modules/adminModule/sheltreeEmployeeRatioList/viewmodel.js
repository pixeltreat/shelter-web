define(["Boiler", 'text!./help/help.html'], function (Boiler, helpTmpl) {
    ...
    var ViewModel = function (moduleContext) {
        ...
        var vm = kendo.observable({
            ...
            dsSheltreeEmployeeRatio: function () {
            ...
            fillGrid: function () {
                ...
                this.set("dsSheltreeEmployeeRatio", $ct.ds.admin.sheltreeEmployeeRatio.getSheltreeEmployeeRatio(this));
              


            },

            searchSheltreeEmployeeRatio: function (e) {
            ...
            refreshSheltreeEmployeeRatioGrid: function (e) {
                vm.dsSheltreeEmployeeRatio.read();
            },
            ...
            sheltreeEmployeeRatioEditUrl: function (isNew) {

                if (!isNew) {
                    return $ct.rn.getSheltreeEmployeeRatio() + "/" + this.selectedId;
                }
                else {
                    return $ct.rn.getSheltreeEmployeeRatio() + "/" + $ct.constants.getNewRecordId();
                }
            },

            btnAddClick: function (e) {
                Boiler.UrlController.goTo(this.sheltreeEmployeeRatioEditUrl(true));
            },
            ...
            btnDeleteClick: function (e) {
                ...
                $ct.ds.admin.sheltreeEmployeeRatio.deletesheltreeEmployeeRatioById(this, function (data) {
                    ...
                    if (errorObj != null) {
                        ...
                        moduleContext.notify($ct.en.getShowSuccMsg(), $ct.msg.getSheltereeEmployeeDeleteSuccessMsg());
                    }
