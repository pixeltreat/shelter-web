    ...
    var ViewModel = function (moduleContext) {
        ...
        var vm = kendo.observable({
            ...
            initialize: function () {
                ...
                $ct.helpers.clearValidations("vwStaffRawDataReport");

                moduleContext.notify($ct.en.getHideErrorMsg());
                $ct.helpers.displayWorkAreaBusyCursor();

                $ct.ds.reports.getLookupsForStaffRawDataReport(function (result) {
            ...
            btnStaffRawGenerateReportClick: function () {
                ...
                var validator = $("#vwStaffRawDataReport").kendoValidator().data("kendoValidator");
                ...
                $ct.ds.reports.genarateStaffRawDataReport(objectForExcel, function (result) {
